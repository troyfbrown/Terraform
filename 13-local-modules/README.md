A networking moudle that should:
1. [DONE]Create a VPC with a given CIDR block
2. Allow the user to provide configuration for multiple subnets
  ...
  2.3 The user should be able to mark a subnet as public or private
    ...
    2.3.2 We need to associate the public subnet with a pbulic RTB